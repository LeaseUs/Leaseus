...
export function Login() {
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-center justify-center px-6 max-w-md mx-auto relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50"
    >
